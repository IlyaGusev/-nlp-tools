...
from utils.bow import bow, get_sentence_tags
...
for review in train["review"].tolist():
    pos_train_data.append(get_sentence_tags(review, 'en'))
pos_train_data, pos_test_data = bow(pos_train_data, pos_test_data, stem=False, use_tfidf=False, language='en')
